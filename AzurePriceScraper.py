...
class AzurePriceList:
    ...
    def scrape(self):
        ...
        while True:
            ...
            # prices = soup.find(string="europe-west")
            # self.log.info("Prices: %s", prices)
